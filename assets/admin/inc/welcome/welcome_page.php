...
?>
 ...
 <div class="wrap about-wrap">
 	...
 	<h1><?php printf( __( 'LoadingLogo &nbsp;%s' ), $ll_version ); ?></h1>

 	<div class="about-text">
 		<?php printf( __( 'LoadingLogo adds your logo with cool effects while the page loads itself.' ), $ll_version ); ?>
 	</div>

 	<div class="ll_logo"></div>
	...
	<div class="changelog feature-section two-col">
		<div class="col">
			<img src="<?php echo LL_URL . '/assets/admin/inc/welcome/assets/img/1.png'; ?>" />
		...
		<div class="col">
			<img src="<?php echo LL_URL . '/assets/admin/inc/welcome/assets/img/2.png'; ?>" />
	...
	<div class="changelog feature-section two-col">
		<div class="col">
			<img src="<?php echo LL_URL . '/assets/admin/inc/welcome/assets/img/3.png'; ?>" />
		...
		<div class="col">
			<img src="<?php echo LL_URL . '/assets/admin/inc/welcome/assets/img/4.png'; ?>" />
		...
		<div class="feature-section one-col ">
			...
			<div class="ll_subscribe">

				<dic class="ll_subscribe__first">

					<img src="<?php echo LL_URL . '/assets/admin/inc/welcome/assets/img/logo_transparent.png' ?>" style="width: 10rem;">
